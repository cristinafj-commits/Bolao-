...
import { Award, Target, HelpCircle, Check, Play, Crown, Sparkles, Flame, TrendingUp } from 'lucide-react';
      ...
      {scores.length > 0 && (
        <div className="bg-gradient-to-b from-emerald-50/50 via-yellow-50/20 to-white p-5 pb-6 border-b border-emerald-100/40 relative overflow-hidden" id="podium-showcase">
          ...
          <div className="text-center mb-5">
            <span className="text-[9px] bg-amber-500/15 text-amber-700 border border-amber-300/30 px-3 py-1 rounded-full font-black uppercase tracking-widest inline-flex items-center gap-1.5 shadow-2xs">
